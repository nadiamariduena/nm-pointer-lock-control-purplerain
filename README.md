...
[controls / pointer lock | CODE](https://threejs.org/examples/?q=lock#misc_controls_pointerlock)
...
## I tried it in my UDEMY example and it worked!

[<img src="./src/images/udemy_keysmoving.gif"/>]()
...
## TESTING IT in my other project
...
- In this example I can finally use the "jump" key :)
...
[<img src="./src/images/_keys_wroking.gif"/>]()
...
#### Controls are funny to play with, So I will give it another try later
